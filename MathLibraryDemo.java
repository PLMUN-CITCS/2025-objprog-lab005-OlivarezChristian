...
double base = 2;
int exponent = 3;
double powerResult = Math.pow(base, exponent); //Calculate the power

double numberForSqrt = 16;
double sqrtResult = Math.sqrt(numberForSqrt); //Calculate the sqaure root

double decimalNumber = 5.67;
long roundedNumber = Math.round(decimalNumber); //Round Decimal Value
